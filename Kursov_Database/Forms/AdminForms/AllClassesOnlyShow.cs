...
{
    public partial class AllClassesOnlyShow : Form
    {
        MySqlConnection Connection;
        public AllClassesOnlyShow()
        {
            InitializeComponent();
        ...
        void ShowAllPerks()
        {
            ...
            Table = new DataTable();
            Adapter = new MySqlDataAdapter("select `Name` from `kursach_database`.class;", Connection);
            Adapter.Fill(Table);
        ...
        private void CellMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            try
            {
                ...
                MySqlDataAdapter Adapter;
                Table = new DataTable();
                Adapter = new MySqlDataAdapter("select `Information` from `kursach_database`.class where Name = '" + value.ToString() + "';", Connection); 
                Adapter.Fill(Table);
